...
The application can tile a url into layers arranged in a grid to test multiple HTML browser instances.  The following example uses the `--grid` command-line switch to specify a 2 x 2 grid:
